...
use gtk4::prelude::*;
use gtk4::{
    gdk, gio, glib, Align, Box as GtkBox, Button, DropTarget, Entry, GestureClick, Label,
...
// use: the shared view/search row and sidebar row lookup, the gnudb email
// prompt, the Send-to ▸ Disc Drive queue, and the player state the transport
// checks read.
use super::{
    context_popover, find_row_by_name, gtk_safe, make_view_search_row, prompt_gnudb_email,
    queue_paths_to_drive, MlCtx, PlayerState,
};
